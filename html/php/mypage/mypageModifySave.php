        ...
        if($result){
            ...
            if($memberInfo['memberID'] == $memberID){
                ...
                if($fileType == "image"){
                    ...
                    $sql = "UPDATE myMember SET youEmail = '{$youEmail}', youIntro = '{$youIntro}', youGender = '{$youGender}', youSite = '{$youSite}', youName = '{$youName}', youBirth = '{$youBirth}', youPhone = '{$youPhone}', youPass = '{$youPass}', youNickName = '{$youNickname}', youPhoto = 'default.svg' WHERE memberID = '{$memberID}'";
                    $connect -> query($sql);
                    $result = $connect -> query($sql);
                    $result = move_uploaded_file($myPageTmp, $myPageDir.$myPageName);
                    }               
